...
if '__file__' not in globals():
    ...
    ) + '/Machine_Learning_A-Z_Mine/Part 3 - Classification/Section 20 - Random Forest Classification')
...
for n_trees in [1, 5, 10]:
    scores = evaluate_algorithm(df, random_forest, n_folds,
